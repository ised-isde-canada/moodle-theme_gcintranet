...
<div class="clearfix">
<div class="well">
 <h2><abbr title="Web Experience Toolkit for Moodle">WET-BOEW-MOODLE</abbr> GCIntranet theme</h2>
 <p><img class="img-polaroid" src="gcintranet/pix/screenshot.png" /></p>
</div>
<div class="well">
 <h2>Credits</h2>
 <h3>About</h3>
 <p>WET-BOEW-MOODLE GCIntranet is a responsive Moodle theme based on the latest GCIntranet <a href="http://www.tbs-sct.gc.ca/ws-nw/index-eng.asp">Web Standards for the Government of Canada</a> and the Moodle core Boost theme.</p>
...
$string['privacy:metadata'] = 'The WET-BOEW-Moodle GCIntranet theme does not store any personal data about any user.';
$string['configtitle'] = 'WET-BOEW-GCIntranet';
