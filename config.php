...
/**
 * WET-BOEW GCIntranet theme config.
 *
...
//$THEME->prescsscallback = 'theme_gcintranet_get_pre_scss';
...
$THEME->scssx = function($theme) {
    return theme_gcintranet_get_main_scss_content($theme);
};
//$THEME->csstreepostprocessor = 'theme_gcintranet_css_tree_post_processor'; // Causes issues. Requires Clear Cache to take effect.
$THEME->extrascsscallback = 'theme_gcintranet_get_extra_scss';
